...
<!--<span class="multisearchform" id="Fornitore"></span>-->
                  ...
                  <tr>
                    <td valign="top">
                      <%{  WebLabelCompound label = new com.thera.thermfw.web.WebLabelCompound(null, null, "YHdrImpMisure", "ClassHdr", null); 
   label.setParent(YHdrImpMisureForm); 
%><label class="<%=label.getClassType()%>" for="Descrittore"><%label.write(out);%></label><%}%>
                    </td>
                    <td valign="top">
                      <% 
  WebMultiSearchForm YHdrImpMisureDescrittore =  
     new com.thera.thermfw.web.WebMultiSearchForm("YHdrImpMisure", "Descrittore", false, false, true, 1, null, null); 
  YHdrImpMisureDescrittore.setParent(YHdrImpMisureForm); 
  YHdrImpMisureDescrittore.write(out); 
%>
<!--<span class="multisearchform" id="Descrittore"></span>-->
                    </td>
                  </tr>
                  <tr>
...
%><label class="<%=label.getClassType()%>" for="YClassAdImpMisure"><%label.write(out);%></label><%}%>
  ...
  WebEditGrid YHdrImpMisureYClassAdImpMisure =  
     new com.thera.thermfw.web.WebEditGrid("YHdrImpMisure", "YClassAdImpMisure", 8, new String[]{"TitoloColonna", "IdFornitore", "IdAzienda", "ClassHdr", "ClassAd", "ValoreDefault", "Escludi", "Azienda.Descrizione"}, 1, null, null,false,"com.thera.thermfw.web.servlet.GridActionAdapterForIndependentRow"); 
...
%>
<BR><% 
   request.setAttribute("parentForm", YHdrImpMisureForm); 
   String CDForYClassAdImpMisure = "YClassAdImpMisure"; 
%>
<jsp:include page="/it/valvorobica/thip/base/importazione/YClassAdImpMisure.jsp" flush="true"> 
<jsp:param name="EditGridCDName" value="<%=CDForYClassAdImpMisure%>"/> 
